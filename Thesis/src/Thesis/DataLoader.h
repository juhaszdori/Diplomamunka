...
public:
	...
	static std::unordered_map<std::string, Product> BuildDataStructure(const std::vector<ProductionEvent>& vProductionEvents, const std::vector<ProductionTimeData>& vProductionTimeData );
